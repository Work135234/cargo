...
async function calculateDistance(origin, destination) {
  try {
    // Debug: Print the OpenCage API key to verify it's loaded
...
async function calculateFare(origin, destination, weight, modeOfTransport) {
  try {
    ...
    try {
      ...
      // Fallback: use a simple distance calculation or default value
      distance = 10; // Default 10km if API fails
    }
